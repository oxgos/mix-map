...
export default class BaiduMap extends Map {
  ...
  static getAddress(point) {
    return new Promise((resolve, reject) => {
      ...
      geoc.getLocation(BaiduMap.getPoint(point), function(rs) {
  ...
  centerAndZoom(centerPoint, zoom) {
    this.map.centerAndZoom(BaiduMap.getPoint(centerPoint), zoom)
  }
  /**
   * 设置marker
   * @param {Object} Point 
   */
  setMarker(point) {
    const marker = new BMap.Marker(BaiduMap.getPoint(point))
